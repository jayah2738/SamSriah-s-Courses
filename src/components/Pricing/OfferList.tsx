const checkIcon = (
  <svg width="8" height="6" viewBox="0 0 8 6" className="fill-green-500">
...
const crossIcon = (
  <svg width="7" height="7" viewBox="0 0 8 8" className="fill-amber-500">
...
const OfferList = ({
  ...
  return (
    <div className="mb-3 flex items-center">
      <span className="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-amber-500 bg-opacity-10 text-amber-500">
